...
def main():
  image2 = 'https://sudipbhujel.com.np/sentiment-analysis-with-logistic-regression/featured-image.png'
  ...
  st.title("Predicting Finanacial sentiment")
  html_temp = """
  ...
  if add_selectbox == 'Online':
      ...
      Sentence = st.text_input("enter tour text",key ="account_lenght")  
      raw_text = [Sentence]
